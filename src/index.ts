    ...
    async init() {
        ...
        this.server.tool(
            ...
            async ({inputSchema}) => {
                ...
                const payload = {
                    address: {
                        addressLines: [inputSchema.address], // Address lines should be an array
                        locality: inputSchema.city,
                        postalCode: inputSchema.zip,
                        regionCode: inputSchema.region_code,
                        administrativeArea: inputSchema.state,
                    },
